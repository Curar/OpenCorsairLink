...
podaj :"
read;
sudo OpenCorsairLink.elf --device 0 --pump mode=${REPLY}
...
podaj :"
read;
sudo OpenCorsairLink.elf --device 0 --fan channel=0,mode=${REPLY}
sudo OpenCorsairLink.elf --device 0 --fan channel=1,mode=${REPLY}
